...
public class GetCustomerInformationDataUpdate
    ...
    public GetCustomerInformationDataUpdate(OnDataAvailable callBack, CustomerInformation model) {
    ...
    protected CustomerInformation doInBackground(String... params) {
        ...
        FetcherAbstract RawDataFetcher = new CustomerInformationUpdateFetcher(this, json, model.getId().toString());
